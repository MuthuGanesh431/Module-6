...
## Output
<img width="481" height="698" alt="image" src="https://github.com/user-attachments/assets/0ceb85d0-eeac-44c4-95dd-07a32e484581" />

## Result
Successfully wrote a **abstract class** named `Shape` with an **abstract method** `calculate_area`, and implement this method in two subclasses: `Rectangle` and `Circle`.
...
```
## OUTPUT
<img width="267" height="171" alt="image" src="https://github.com/user-attachments/assets/66edd78a-ee9d-4fdb-8647-5983b8602cc4" />
...
```
## Output
<img width="306" height="235" alt="image" src="https://github.com/user-attachments/assets/820e5f70-cddc-4724-9c74-4393e6f85ce8" />

## Result
Successfully wrote a two specific classes — `Beans` and `Mango`. Then, create a **generic function** that can accept any object and determine its **type** (Fruit or Vegetable) and **color**, using polymorphism.
